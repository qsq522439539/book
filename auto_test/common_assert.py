...
class CommonAssert(object):
    ...
    def get_ticket_order(self):
        sql = "select ticket_product_id,member_id,quantity,price,paid,deduction,refund,channel,from_type,from_id,settle_condition," \
    ...
    def get_sale_order(self):
        ...
        # assign_member_level_source:指定会员等级来源(1:代客下单,2:权益卡引导,3:储值卡充值引导)'
